...
type FindShowSuggestionsRequest struct {
...
func (h Handler) HandleRequest(ctx context.Context, req FindShowSuggestionsRequest) FindShowSuggestionsResponse {
	if req.Token == "" {
		h.l.Info().Msg("Token is required")
		return FindShowSuggestionsResponse{
